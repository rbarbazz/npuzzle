...
function (_Component) {
  ...
  function Visu(props) {
    ...
    _this.state = {
      basePuzzle: _this.props.basePuzzle,
  ...
  _createClass(Visu, [{
    ...
    value: function render() {
      ...
      }, this.state.basePuzzle.map(function (e, index) {
        return react_default.a.createElement("div", {
          key: 'puzzle-case_' + index,
          className: "puzzle-case",
          style: {
            width: 100 / _this2.state.size + "%",
            height: 100 / _this2.state.size + "%"
          }
...
function (_Component2) {
  ...
  function InputForm(props) {
    ...
    _this3 = _possibleConstructorReturn(this, _getPrototypeOf(InputForm).call(this, props));
    _this3.state = {
      inputPuzzle: '',
      size: 3,
      isSolvable: true,
    ...
    value: function render() {
      ...
      return react_default.a.createElement("div", {
        ...
        onClick: function onClick() {
          return _this4.props.sendInputPuzzle(_this4.state.inputPuzzle);
        }
        ...
        max: "8",
        onChange: function onChange(e) {
          return _this4.handleSizeInput(e.target.value);
        },
        ...
        max: "10000",
        onChange: function onChange(e) {
          return _this4.handleIterationsInput(e.target.value);
        },
        value: this.state.iterations
      })), react_default.a.createElement("button", {
        className: "input-validation",
        onClick: function onClick() {
          return _this4.props.sendGenParams(_this4.state.size, _this4.state.isSolvable, _this4.state.iterations);
        }
      }, "Validate")));
    }
  }]);
...
function (_Component3) {
  ...
  function NPuzzle(props) {
    ...
    _this5 = _possibleConstructorReturn(this, _getPrototypeOf(NPuzzle).call(this, props));
    _this5.state = {
      size: 3,
      stepNumber: 0,
      basePuzzle: []
    };
    _this5.sendInputPuzzle = _this5.sendInputPuzzle.bind(_assertThisInitialized(_this5));
    _this5.sendGenParams = _this5.sendGenParams.bind(_assertThisInitialized(_this5));
    return _this5;
  }
  ...
  _createClass(NPuzzle, [{
    ...
    value: function render() {
      ...
      }), this.state.stepNumber == 1 && react_default.a.createElement(NPuzzle_Visu, {
